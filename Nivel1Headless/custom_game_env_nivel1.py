...
class CustomGameEnv1(gym.Env):
    ...
    def step(self, action):
        ...
        #*if self.last_position == position:
            #no_move_penalty = 10  # Apply a penalty for staying in the same position
            #reward += no_move_penalty
            #print("Penalty: Agent did not move.")
            #self.episode_reward_details["no_move_penalty"] += no_move_penaltydwdw
