...
exe_path = "C:\\Users\\ghost\\Documents\\TESIS\\Nivel1\\Abby's Redemption1SIN"
...
model = DQN("MlpPolicy", env, verbose=1, buffer_size=100000, learning_rate=5e-4, batch_size=32,
            exploration_fraction=0.1, exploration_final_eps=0.02, target_update_interval=1000, gamma=0.99, train_freq=4)
...
# Entrenar el agente con model.learn y el callback (prueba inicial con 15,000 steps)
model.learn(total_timesteps=10000, callback=reward_callback)

# Guardar el modelo entrenado
model.save("dqn_custom_game_model")
